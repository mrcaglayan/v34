...
Promise.all([
    fetch('https://vercel.com/ufuks-projects-c6a815ff/apiii/5oP2Aoc6yiLN31s2i8eEHsboMLX7/api/allDiscountOptions').then(response => response.json()),
    fetch('https://vercel.com/ufuks-projects-c6a815ff/apiii/5oP2Aoc6yiLN31s2i8eEHsboMLX7/api/tables').then(response => response.json())
])
...
function sendDiscountsToServer() {
    fetch('https://vercel.com/ufuks-projects-c6a815ff/apiii/5oP2Aoc6yiLN31s2i8eEHsboMLX7/api/allDiscountOptions', {
        method: 'POST',
        headers: {
