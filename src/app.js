document.addEventListener('DOMContentLoaded', function() {
    ...
    if (userType === 'user') {
        ...
        schoolSelect.addEventListener('change', function() {
            ...
            fetch('https://vercel.com/ufuks-projects-c6a815ff/apiii/5oP2Aoc6yiLN31s2i8eEHsboMLX7/api/tables')
                .then(response => {
                    if (!response.ok) {
                        throw new Error('Network response was not ok');
                    }
    ...
    document.getElementById('user-login').addEventListener('click', function() {
        ...
        if (username && password && school && year) {
            fetch('https://vercel.com/ufuks-projects-c6a815ff/apiii/5oP2Aoc6yiLN31s2i8eEHsboMLX7/api/users')
                .then(response => {
                    if (!response.ok) {
                        throw new Error('Network response was not ok');
                    }
