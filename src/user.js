...
function saveData(endpoint, data, username, selectedYear) {
    fetch(`https://vercel.com/ufuks-projects-c6a815ff/apiii/5oP2Aoc6yiLN31s2i8eEHsboMLX7/api/${endpoint}`, {
        method: 'POST',
...
function fetchTableStructure(year) {
    fetch(`https://vercel.com/ufuks-projects-c6a815ff/apiii/5oP2Aoc6yiLN31s2i8eEHsboMLX7/api/tables?year=${year}`)
    .then(response => handleResponse(response))
    .then(data => {
...
function fetchStudents(username, selectedYear) {
    fetch(`https://vercel.com/ufuks-projects-c6a815ff/apiii/5oP2Aoc6yiLN31s2i8eEHsboMLX7/api/students?username=${encodeURIComponent(username)}&year=${encodeURIComponent(selectedYear)}`)
    .then(response => handleResponse(response))
    .then(data => {
...
function deleteData(endpoint, id, username, selectedYear) {
    fetch(`https://vercel.com/ufuks-projects-c6a815ff/apiii/5oP2Aoc6yiLN31s2i8eEHsboMLX7/api/${endpoint}/${id}`, { method: 'DELETE' })
    .then(response => handleResponse(response))
    .then(data => {
...
function saveEditedData(studentId, updatedStudentData) {
    fetch(`https://vercel.com/ufuks-projects-c6a815ff/apiii/5oP2Aoc6yiLN31s2i8eEHsboMLX7/api/students/${studentId}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
...
function saveEditedDatacompleteentrydb(studentId, updatedStudentData) {
    fetch(`https://vercel.com/ufuks-projects-c6a815ff/apiii/5oP2Aoc6yiLN31s2i8eEHsboMLX7/api/completeentrydb/${studentId}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(updatedStudentData)
    })
...
document.getElementById('search-button').addEventListener('click', () => {
    ...
    if (studenttezkereNo) {
        ...
        let url = `https://vercel.com/ufuks-projects-c6a815ff/apiii/5oP2Aoc6yiLN31s2i8eEHsboMLX7/api/completeentrydb?studenttezkereNo=${encodeURIComponent(studenttezkereNo)}`;
...
applyButton.addEventListener('click', () => {
    ...
    function fetchSchoolData(school) {
        fetch('https://vercel.com/ufuks-projects-c6a815ff/apiii/5oP2Aoc6yiLN31s2i8eEHsboMLX7/api/schools')
        .then(response => handleResponse(response))
        .then(data => {
